---
title: Neural video compression dataset and benchmark
permalink: /nvc-dataset-benchmark
features:
  - Real-world distortions from video conferencing apps
  - 80 videos, 2880 sistorted versions
  - 12,000+ assessors
---
...
{% include dataset_access_request.html dataset_name=site.data.dataset_access_forms.nvc.dataset_name form_url=site.data.dataset_access_forms.nvc.url %}
